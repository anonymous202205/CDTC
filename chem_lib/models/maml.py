...
def maml_update(model, lr, grads=None, adaptable_weights=None, anil=False, pr=False):
	"""
...
class MAML(BaseLearner):
	...
	**Example**
	...
	def adapt(
			self, loss, adaptable_weights=None, first_order=None, allow_unused=None, allow_nograd=None, anil=None, pr=False):
		"""
		**Description**
		...
		* **allow_nograd** (bool, *optional*, default=None) - Whether to allow adaptation with
		...
		if allow_nograd:
			# for i, j in self.module.named_parameters():
			# 	print(i, j.requires_grad)
			# Compute relevant gradients
			# for p in adaptable_weights:
			# 	if p.requires_grad:
			# 		print('require', p.shape)
		...
		# Update the module
		self.module = maml_update(self.module, self.lr, gradients, adaptable_weights, anil, pr=pr)
